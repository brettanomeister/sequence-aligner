...
def run_sequence_alignment_search(self, run_id: int, query: str):
    ...
    try:
        ...
        search_records(query, sequence_records, run_id)
    except Exception as e:
        raise self.retry(exc=e)


def search_records(query: str, sequence_records, run_id: int):
    for sr in sequence_records:
        record = sr[1]
        search_record(query, record, run_id)


def search_record(query: str, record, run_id: int):
    alignments = []
